...
-- 8: HR Interview
(13, 'HR Policies', 'HR processes & labor law basics', 8),
(14, 'Culture Fit', 'Values and teamwork', 8),

-- 9: Data Interview
(15, 'SQL & Statistics', 'Joins, window functions, hypothesis testing', 9),
(16, 'Python/Analytics Case', 'Pandas/numpy case exercise', 9),

-- 10: Frontend Interview
(17, 'React & JS', 'Components, state, hooks', 10),
(18, 'UI/UX Discussion', 'Accessibility & responsive design', 10),

-- 11: Recruitment Interview
(19, 'Sourcing Strategy', 'Channels, outreach & funnels', 11),
(20, 'Stakeholder Management', 'Collaboration with hiring managers', 11),

-- 12: Data Eng. Interview
(21, 'ETL Design', 'Pipelines & data quality checks', 12),
(22, 'Data Modeling', 'Warehouse patterns & partitioning', 12),

-- 13: DevOps Interview
(23, 'CI/CD Deep Dive', 'Pipelines, testing & release', 13),
(24, 'Kubernetes & Infra', 'Containers, k8s, networking', 13),

-- 14: Training Interview
(25, 'Needs Analysis', 'Identify training needs & gaps', 14),
(26, 'Program Design', 'Learning paths, delivery & KPIs', 14),

-- 15: ML Interview
(27, 'ML Fundamentals', 'Algorithms, metrics & bias', 15),
(28, 'Deployment/MLOps', 'Serving, monitoring & drift', 15),

-- 16: Senior Backend Interview
(29, 'System Design', 'Scalability, consistency & trade-offs', 16),
(30, 'Code Review', 'Best practices & refactoring', 16),

-- 17: HR Assistant Interview
(31, 'Admin Processes', 'Onboarding & records management', 17),
(32, 'Communication', 'Conflict resolution & empathy', 17),

-- 18: Junior Data Interview
(33, 'Excel & Basics', 'Formulas, charts, pivots', 18),
(34, 'SQL Basics', 'SELECTs, joins, grouping', 18),

-- 19: Frontend Intern Interview
(35, 'JS Basics', 'ES6, DOM & events', 19),
(36, 'Portfolio/Exercises', 'Small tasks & feedback', 19),

-- 20: Freelance Recruiter Interview
(37, 'Pipeline Strategy', 'Sourcing remote candidates', 20),
(38, 'Case Study', 'Scenario-based assessment', 20),

-- 21: ETL Specialist Interview
(39, 'Data Cleaning', 'Transforms, mapping & validation', 21),
(40, 'Orchestration', 'Schedulers (Airflow etc.)', 21),

-- 22: SRE Interview
(41, 'Incident Response', 'On-call, runbooks & postmortems', 22),
(42, 'Reliability/Monitoring', 'SLIs/SLOs & observability', 22),

-- 23: L&D Interview
(43, 'Learning Strategy', 'L&D roadmap & stakeholders', 23),
(44, 'Content Creation', 'Workshops & materials', 23),

-- 24: AI Research Interview
(45, 'Research Methods', 'Papers, novelty & rigor', 24),
(46, 'Model Evaluation', 'Benchmarks & ablations', 24);
