...
public class CandidateService {
    ...
    private final CandidateRepository candidateRepository;
    private final CandidateMapper candidateMapper;
    private final JobAdRepository jobAdRepository; // ✅ χρειάζεται για να κάνουμε save το JobAd
    ...
    public CandidateService(CandidateRepository candidateRepository,
        ...
        this.candidateRepository = candidateRepository;
        this.candidateMapper = candidateMapper;
        this.jobAdRepository = jobAdRepository; // ✅ inject
    }
    ...
    public Candidate updateCandidate(Integer candidateId, Candidate updatedFields) {
        ...
        return candidate; // managed entity
    }
    ...
    public void updateStatus(Integer candidateId, CandidateStatusDTO dto) {
        ...
        if (dto != null) {
            candidateMapper.updateStatusFromDto(dto, candidate);
        }
    }
    ...
    public CandidateAndJobAdStatusDTO hireCandidate(Integer candidateId) {
        ...
        return new CandidateAndJobAdStatusDTO(
                ...
                cand.getStatus(),
                job.getId(),
                job.getStatus(),  // θα μείνει ως έχει (π.χ. "Open")
                hiredCount
        );
    }
